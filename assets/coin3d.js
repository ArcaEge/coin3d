...
function assignWasmExports(wasmExports) {
  Module['__sapp_emsc_onpaste'] = __sapp_emsc_onpaste = createExportWrapper('_sapp_emsc_onpaste', 1);
  Module['__sapp_html5_get_ask_leave_site'] = __sapp_html5_get_ask_leave_site = createExportWrapper('_sapp_html5_get_ask_leave_site', 0);
  Module['__sapp_emsc_begin_drop'] = __sapp_emsc_begin_drop = createExportWrapper('_sapp_emsc_begin_drop', 1);
  Module['__sapp_emsc_drop'] = __sapp_emsc_drop = createExportWrapper('_sapp_emsc_drop', 2);
  Module['__sapp_emsc_end_drop'] = __sapp_emsc_end_drop = createExportWrapper('_sapp_emsc_end_drop', 3);
  Module['__sapp_emsc_invoke_fetch_cb'] = __sapp_emsc_invoke_fetch_cb = createExportWrapper('_sapp_emsc_invoke_fetch_cb', 8);
  Module['__sapp_emsc_set_fullscreen_flag'] = __sapp_emsc_set_fullscreen_flag = createExportWrapper('_sapp_emsc_set_fullscreen_flag', 1);
  ...
  dynCalls['idi'] = dynCall_idi = createExportWrapper('dynCall_idi', 3);
